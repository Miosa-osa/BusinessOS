<script lang="ts">
	...
	onMount(() => {
		...
		// The session cookie is HttpOnly, so ask the backend instead of reading document.cookie.
		getSession()
			.then(({ data }) => {
				if (data?.user) goto('/dashboard', { replaceState: true });
			})
			.catch(() => {});
...
<main>
	...
	<section class="lp-hero" aria-labelledby="lp-hero-headline">
		<div class="lp-container lp-hero__content {visible ? 'lp-hero__content--visible' : ''}">
			...
			<div class="lp-hero__os-badge" style="margin-top:0.9rem;font-size:0.9rem;font-weight:600;">
				One native desktop app — works on all your devices.
			</div>
	...
	<!-- Section 2.5: Cloud + your own desktop -->
	<section class="lp-hierarchy" aria-labelledby="lp-cloud-headline">
		<div class="lp-container">
			<div class="lp-section-header">
				<p class="lp-eyebrow">Cloud + your own desktop</p>
				<h2 class="lp-headline" id="lp-cloud-headline">Run it your way.<br />Local-first, cloud-connected.</h2>
				<p class="lp-subheadline">
					Use BusinessOS right here in your browser (the cloud), or run the <strong>desktop app</strong> on your own machine. Your account carries your <strong>structure</strong> across both - organizations, workspaces, teams, modules, and apps. Your <strong>data stays local by default</strong>; sync only what you choose to the cloud, per workspace. Signing in associates your hierarchy, never your private data unless you decide to share it.
				</p>
			</div>
		</div>
	</section>
	...
	<section class="lp-modules" id="modules" aria-labelledby="lp-modules-headline">
		<div class="lp-container">
			<div class="lp-section-header">
				<p class="lp-eyebrow">Core modules + unlimited custom</p>
				<h2 class="lp-headline" id="lp-modules-headline">Everything you need — and everything you build</h2>
				<p class="lp-subheadline">Start with the core modules, then build your own. This is where you create unlimited custom modules — your fields, your data, your workflows — no code required.</p>
			</div>
			...
			<div class="lp-modules__custom" style="margin-top:2rem;text-align:center;">
				<p style="font-size:1.05rem;font-weight:600;margin-bottom:0.35rem;">Need something we don't have? Build it.</p>
				<p style="opacity:0.7;max-width:44rem;margin:0 auto;">Every workspace can spin up its own custom modules in minutes — data lives per-workspace, stays yours, and syncs to the cloud only when you choose.</p>
			</div>
		</div>
	</section>
