<script lang="ts">
	...
	// Honor ?redirect= (e.g. a workspace invite) — same-site paths only.
...
<AuthLayout>
	<div in:fly={{ y: 20, duration: 400 }}>
		...
		<p class="auth-footer-link">
			...
			<a href={redirectTo ? `/login?redirect=${encodeURIComponent(redirectTo)}` : '/login'} class="auth-footer-action">Sign in</a>
		</p>
	</div>
</AuthLayout>
