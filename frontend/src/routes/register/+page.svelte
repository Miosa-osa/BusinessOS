...
<AuthLayout>
	<div in:fly={{ y: 20, duration: 400 }}>
		...
		<div class="mb-8">
			...
			<p class="text-gray-600">Get started with Business OS</p>
		</div>
		...
		<form onsubmit={handleSubmit} class="space-y-5">
			...
			<label class="flex items-start gap-3 cursor-pointer group">
				...
				<span class="text-sm text-gray-600 leading-relaxed">
					I agree to the
					<a href="/terms" class="text-gray-900 hover:underline">Terms of Service</a>
					and
		...
		<!-- Social Login -->
		<button type="button" class="btn btn-secondary w-full h-12 flex items-center justify-center gap-3">
