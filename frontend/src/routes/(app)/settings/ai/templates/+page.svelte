...
<div class="templates-page">
  ...
  <div class="page-header">
    <div class="header-content">
      ...
      <button class="btn-pill btn-pill-ghost btn-primary" onclick={openCreateModal}>
        <Plus class="w-5 h-5" />
          ...
          <div class="template-card">
            <div class="card-header">
              ...
              <div class="card-actions">
                <button
                  class="btn-pill btn-pill-ghost btn-icon"
                ...
                <button
                  class="btn-pill btn-pill-ghost btn-icon danger"
            ...
            {#if !template.is_default}
              <button
                class="btn-pill btn-pill-ghost btn-secondary full-width"
  ...
  <div class="modal-overlay" onclick={closeModals}>
    <div class="modal" onclick={(e) => e.stopPropagation()}>
      <div class="modal-header">
        ...
        <button class="btn-pill btn-pill-ghost btn-icon" onclick={closeModals}>
          <X class="w-5 h-5" />
        </button>
      </div>
      ...
      <div class="modal-content">
        ...
        <div class="form-group">
          <div class="steps-header">
            <label>Steps</label>
            <button class="btn-pill btn-pill-ghost btn-sm" onclick={addStep}>
              <Plus class="w-4 h-4" />
              <span>Add Step</span>
            </button>
          </div>
      ...
      <div class="modal-footer">
        <button class="btn-pill btn-pill-ghost btn-secondary" onclick={closeModals}>
          Cancel
        </button>
        <button class="btn-pill btn-pill-ghost btn-primary" onclick={handleCreate}>
  ...
  <div class="modal-overlay" onclick={closeModals}>
    <div class="modal" onclick={(e) => e.stopPropagation()}>
      ...
      <div class="modal-footer">
        ...
        <button class="btn-pill btn-pill-ghost btn-primary" onclick={handleUpdate}>
          <CheckCircle class="w-4 h-4" />
