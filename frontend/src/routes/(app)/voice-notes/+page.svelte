						...
						<div class="notes-list">
							{#each notes as note}
								...
								<div class="note-card" class:expanded={isExpanded}>
									<button class="btn-pill btn-pill-ghost note-main" onclick={() => toggleExpand(note.id)}>
									...
									{#if isExpanded}
										<div class="note-actions">
											<button class="btn-pill btn-pill-ghost action-btn copy" onclick={() => copyTranscript(note)}>
												{#if copiedId === note.id}
													<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
