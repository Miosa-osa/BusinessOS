...
{#if compact}
	<button
		class="btn-pill btn-pill-soft btn-pill-xs w-full text-left truncate {colors.bg} {colors.text}"
		onclick={onClick}
	>
...
{:else}
	<button
		class="btn-pill btn-pill-soft w-full text-left p-3 {colors.border} {colors.bg} border"
		onclick={onClick}
	>
