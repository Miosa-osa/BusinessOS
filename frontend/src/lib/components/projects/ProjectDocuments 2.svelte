...
<div class="bg-white rounded-xl border border-gray-200">
	...
	{:else if availableDocuments.length === 0}
		<div class="text-center py-16">
			...
			<a href="/knowledge{embedSuffix}" class="btn btn-primary">Go to Knowledge Base</a>
		</div>
	{:else}
		...
		<div class="px-4 py-3 border-b border-gray-100 flex items-center justify-between bg-gray-50/50">
			...
			<div class="flex items-center gap-1">
				...
				<div class="flex items-center border border-gray-200 rounded-lg overflow-hidden">
					<button onclick={() => documentPanelMode = 'side'} class="p-1.5 transition-colors bg-gray-900 text-white" aria-label="Side panel">
						<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
							<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17V7m0 10a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2h2a2 2 0 012 2m0 10a2 2 0 002 2h2a2 2 0 002-2M9 7a2 2 0 012-2h2a2 2 0 012 2m0 10V7" />
						</svg>
					</button>
					<button onclick={() => documentPanelMode = 'center'} class="p-1.5 transition-colors text-gray-500 hover:bg-gray-100" aria-label="Center panel">
						<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
							<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zM16 13a1 1 0 011-1h2a1 1 0 011 1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-6z" />
						</svg>
					</button>
					<button onclick={() => documentPanelMode = 'full'} class="p-1.5 transition-colors text-gray-500 hover:bg-gray-100" aria-label="Full screen">
						<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
							<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 8V4m0 0h4M4 4l5 5m11-1V4m0 0h-4m4 0l-5 5M4 16v4m0 0h4m-4 0l5-5m11 5l-5-5m5 5v-4m0 4h-4" />
						</svg>
					</button>
				</div>
				<a href="/knowledge/{selectedDocument.id}{embedSuffix}" class="p-1.5 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-lg transition-colors ml-1" aria-label="Open in full page">
					<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
						<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
					</svg>
				</a>
				<button onclick={closeDocumentPanel} class="p-1.5 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-lg transition-colors" aria-label="Close">
		...
		{:else}
			<div class="flex-1 overflow-y-auto">
				<div class="max-w-none mx-auto px-6 py-8">
					...
					<button onclick={addNewBlockAtEnd} class="w-full min-h-24 mt-4 text-left cursor-text group" aria-label="Add new block">
			...
			<div class="px-4 py-2 border-t border-gray-100 flex items-center justify-between text-xs text-gray-400 bg-gray-50/50">
				...
				<button onclick={saveDocument} class="hover:text-gray-600" disabled={!$editor.isDirty}>Save now</button>
			</div>
		{/if}
		...
		<div class="bg-white rounded-2xl shadow-2xl w-full max-w-4xl h-full max-h-[90vh] flex flex-col overflow-hidden">
			<div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
				...
				<div class="flex items-center gap-2">
					...
					<div class="flex items-center border border-gray-200 rounded-lg overflow-hidden">
						<button onclick={() => documentPanelMode = 'side'} class="p-2 transition-colors text-gray-500 hover:bg-gray-100" aria-label="Side panel">
							<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
								<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17V7m0 10a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2h2a2 2 0 012 2m0 10a2 2 0 002 2h2a2 2 0 002-2M9 7a2 2 0 012-2h2a2 2 0 012 2m0 10V7" />
							</svg>
						</button>
						<button onclick={() => documentPanelMode = 'center'} class="p-2 transition-colors bg-gray-900 text-white" aria-label="Center panel">
							<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
								<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zM16 13a1 1 0 011-1h2a1 1 0 011 1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-6z" />
							</svg>
						</button>
						<button onclick={() => documentPanelMode = 'full'} class="p-2 transition-colors text-gray-500 hover:bg-gray-100" aria-label="Full screen">
							<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
								<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 8V4m0 0h4M4 4l5 5m11-1V4m0 0h-4m4 0l-5 5M4 16v4m0 0h4m-4 0l5-5m11 5l-5-5m5 5v-4m0 4h-4" />
							</svg>
						</button>
					</div>
					<a href="/knowledge/{selectedDocument.id}{embedSuffix}" class="p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-lg transition-colors" aria-label="Open in full page">
						<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
							<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
						</svg>
					</a>
					<button onclick={closeDocumentPanel} class="p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-lg transition-colors" aria-label="Close">
						<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
							<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" />
						</svg>
					</button>
	...
	<div class="fixed inset-0 bg-white z-50 flex flex-col">
		<div class="px-6 py-4 border-b border-gray-200 flex items-center justify-between bg-white">
			<div class="flex items-center gap-3">
				<button onclick={closeDocumentPanel} class="p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-lg transition-colors" aria-label="Back to project">
					<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
			...
			<div class="flex items-center gap-2">
				...
				<div class="flex items-center border border-gray-200 rounded-lg overflow-hidden">
					...
					<button onclick={() => documentPanelMode = 'center'} class="p-2 transition-colors text-gray-500 hover:bg-gray-100" aria-label="Center panel">
						<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
							<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zM16 13a1 1 0 011-1h2a1 1 0 011 1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-6z" />
						</svg>
					</button>
					<button onclick={() => documentPanelMode = 'full'} class="p-2 transition-colors bg-gray-900 text-white" aria-label="Full screen">
						<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
							<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 8V4m0 0h4M4 4l5 5m11-1V4m0 0h-4m4 0l-5 5M4 16v4m0 0h4m-4 0l5-5m11 5l-5-5m5 5v-4m0 4h-4" />
						</svg>
					</button>
				</div>
				<a href="/knowledge/{selectedDocument.id}{embedSuffix}" class="btn btn-secondary text-sm ml-2" aria-label="Open in Knowledge Base">
					Open in Knowledge Base
				</a>
				<button onclick={closeDocumentPanel} class="p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-lg transition-colors ml-2" aria-label="Exit full screen">
					<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
						<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" />
					</svg>
				</button>
		...
		{:else}
			<div class="flex-1 overflow-y-auto bg-gray-50/50">
				<div class="max-w-3xl mx-auto px-8 py-12 bg-white min-h-full shadow-sm">
					...
					<button onclick={addNewBlockAtEnd} class="w-full min-h-32 mt-4 text-left cursor-text group" aria-label="Add new block">
						<span class="text-gray-300 opacity-0 group-hover:opacity-100 transition-opacity text-sm">
							Click to add a block, or press / for commands
						</span>
					</button>
