...
{#if phase === 'conversation' && !isResuming}
	<button class="skip-btn" onclick={onSkip} title="Skip questions and go to integrations">
		Skip for now
	</button>
{/if}
...
<div class="centered-layout">
	...
	<div class="text-section">
		...
		{:else}
			{#if isResuming}
				...
				<button class="continue-resume-btn" onclick={onContinueResume}>
					Continue
				</button>
	...
	{#if phase === 'conversation' && !isAgentTyping && !isResuming}
		<div class="input-section">
			...
			{#if canGoBack}
				<button class="go-back-btn" onclick={onGoBack}>
