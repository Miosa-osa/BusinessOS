<!--
	...
	Calls Pedro's sandbox edit API: apply (requires validated state) and reject.
-->
<script lang="ts">
	...
	let { sandboxId, editState, onApprove, onReject, disabled = false }: Props = $props();
	...
	let needsValidation = $derived(editState === 'pending');
