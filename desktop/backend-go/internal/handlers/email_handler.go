...
func (h *EmailHandler) HandleTestEmail(c *gin.Context) {
	...
	if req.To == "" {
		c.JSON(http.StatusBadRequest, gin.H{"error": "Email recipient is required"})
		return
	}
...
func (h *EmailHandler) HandleSendVerificationEmail(c *gin.Context) {
	...
	if req.To == "" || req.VerificationLink == "" {
		c.JSON(http.StatusBadRequest, gin.H{"error": "Missing required fields: to, verification_link"})
		return
	}
...
func (h *EmailHandler) HandleSendPasswordResetEmail(c *gin.Context) {
	...
	if req.To == "" || req.ResetLink == "" {
		c.JSON(http.StatusBadRequest, gin.H{"error": "Missing required fields: to, reset_link"})
		return
	}
