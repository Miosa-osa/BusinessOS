-- Repair databases that adopted the migration ledger without executing the
-- full-build module migration. This migration intentionally repeats migration
-- 151 with idempotent DDL, then restores the named workspace profiles whose
-- settings drive built-in module visibility.
