...
VALUES ($1, $2, $3, $4, $5, $6)
RETURNING id, workspace_id, email, role_id, role, token, status, expires_at, invited_by, invited_by_id, invited_by_name, invited_at, accepted_at, accepted_by, accepted_by_user_id, created_at, updated_at
`
...
// =========================
func (q *Queries) CreateWorkspaceInvitation(ctx context.Context, arg CreateWorkspaceInvitationParams) (WorkspaceInvite, error) {
...
SELECT id, workspace_id, email, role_id, role, token, status, expires_at, invited_by, invited_by_id, invited_by_name, invited_at, accepted_at, accepted_by, accepted_by_user_id, created_at, updated_at FROM workspace_invites WHERE id = $1 AND workspace_id = $2
`
...
func (q *Queries) GetWorkspaceInvitation(ctx context.Context, arg GetWorkspaceInvitationParams) (WorkspaceInvite, error) {
...
SELECT id, workspace_id, email, role_id, role, token, status, expires_at, invited_by, invited_by_id, invited_by_name, invited_at, accepted_at, accepted_by, accepted_by_user_id, created_at, updated_at FROM workspace_invites
WHERE workspace_id = $1
ORDER BY created_at DESC
`

func (q *Queries) ListWorkspaceInvitations(ctx context.Context, workspaceID pgtype.UUID) ([]WorkspaceInvite, error) {
...
func (q *Queries) ListWorkspaceInvitationsByStatus(ctx context.Context, arg ListWorkspaceInvitationsByStatusParams) ([]WorkspaceInvite, error) {
...
func (q *Queries) UpdateInvitationToken(ctx context.Context, arg UpdateInvitationTokenParams) (WorkspaceInvite, error) {
